...
export function CurrentUserBadge({ user, onSwitch }: CurrentUserBadgeProps) {
  return (
    <motion.button initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} whileTap={{ scale: 0.98 }} onClick={onSwitch} className="fixed top-4 right-4 z-40 bg-card rounded-full px-2.5 py-1 flex items-center gap-1.5 max-w-[calc(100vw-2rem)] border border-border shadow-sm">
