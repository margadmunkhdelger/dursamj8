...
export function MobileNav({ activeTab, onTabChange }: MobileNavProps) {
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-[70] touch-none overscroll-none"
      style={{
  ...
  return (
    <>
      <motion.header
        ...
        className="fixed top-0 left-0 right-0 z-[60] px-4 pt-[max(1rem,env(safe-area-inset-top))] bg-gradient-to-b from-background/95 via-background/80 to-transparent pb-4 touch-none"
        style={{
